...
\begin{center}
$\mathbb{R}^3 = span\left\{\vec{e}_1,\vec{e}_2,\vec{e}_3\right\} = span\left\{
\begin{bmatrix} 
	1 \\
	0 \\
	0
...
$
\end{center}
\textbar{To receive non-standard basis vectors, let us choose vectors that are not equal to $\left\{\vec{e}_1,\vec{e}_2,\vec{e}_3\right\}$. With this in mind, let us choose three linearly independent vectors in R^3. From section one, we learned that a set of vectors are linearly independent if their solution is trivial. Therefore from the vectors we choose, we may verify if they are linearly independent. 
