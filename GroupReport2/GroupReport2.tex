...
\textbar{In the previous Group Report, we outlined the concepts of a basis. In that case, we used standard basis vectors, in which, if we were to take the span of these vectors, it would be equivalent to the set of all vectors in $\mathbb{R}^3$.}
