...
In this duality, conceptually breaking down a projection is far more approachable. There are multiple means of doing this in $\mathbb{R}^3$, but in our case, in $\mathbb{R}^2$, it is much more trivial since $\vec{b}$ is a point in space. Yet, the critical concept remains constant, and it is a matter of making the sphere flush with the two-dimensional subspace. We may assume that the sphere is an element of the subspace. Akin to what breaks down a projection in $\mathbb{R}^2$. }
