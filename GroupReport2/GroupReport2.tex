...
\end{center}
\begin{center}
	$ \vectorproj[A]{\vec{b}} = \vec{a}\frac{\vec{a}^\intercal\vec{b}}{\vec{a}^\intercal\vec{a}} \implies \vectorproj[A]{\vec{b}} = \vec{a}\frac{\vec{a} \cdot \vec{b}}{\vec{a} \cdot \vec{a}}
	$
\end{center}
