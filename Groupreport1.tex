...
%%	\textit{Vectors are a point in a given space, (e.g) $\Vec{0},  \begin{bmatrix}
	...
	\textbf{This is akin to how we establish the basis vectors in a given space, for example if we were to establish the basis vectors in $\mathbb R^3$ it is required to have three linearly independant vectors, such as $\vec{a} = \begin{bmatrix}
			0 \\
			0 \\
			1
