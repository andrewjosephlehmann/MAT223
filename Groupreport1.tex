...
\textbar{To represent the plane in vector form, find the normal vector when taking the cross-product of two linearly independent vectors lying on the plane. Let's find these two vectors that lie on our plane: \\
$\vec{v}_1 = A - B$
$ = \begin{bmatrix}
	1 \\ 
	1 \\
